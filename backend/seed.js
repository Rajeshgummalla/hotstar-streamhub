...
const contents = [
  ...
  },
  {
    ...
    description: 'The mercurial villain Loki resumes his role as the God of Mischief in a new series after Avengers: Endgame.',
...
async function seed() {
  try {
    ...
    const admin = await User.create({
      name: 'Admin User',
      email: process.env.ADMIN_EMAIL || 'admin@hotstar.com',
    ...
    console.log(`✅ Admin: ${admin.email} | Demo: ${demoUser.email}`);
